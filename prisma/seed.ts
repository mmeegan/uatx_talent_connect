...
async function main() {
  ...
  await prisma.studentProfile.upsert({
    ...
    create: {
      ...
      name: "Alex Student",
      tags: JSON.stringify(["product management", "career", "tech"]),
    },
    update: {},
  });
  ...
  const mentor1 = await prisma.mentorProfile.upsert({
    ...
    create: {
      ...
      topics: JSON.stringify(["product management", "career transition", "roadmapping"]),
      industryTags: JSON.stringify(["tech", "SaaS"]),
      availability: "HIGH",
  ...
  await prisma.mentorProfile.upsert({
    ...
    create: {
      ...
      topics: JSON.stringify(["engineering", "tech", "career", "leadership"]),
      industryTags: JSON.stringify(["tech"]),
      availability: "MEDIUM",
  ...
  await prisma.mentorProfile.upsert({
    ...
    create: {
      ...
      topics: JSON.stringify(["design", "career", "product", "UX"]),
      industryTags: JSON.stringify(["tech", "design"]),
      availability: "LOW",
    ...
    if (!existing) {
      const helpRequest = await prisma.helpRequest.create({
        data: {
          ...
          tags: JSON.stringify(["product management", "career transition", "tech"]),
        },
      });
